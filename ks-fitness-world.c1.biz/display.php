...
while($result = mysqli_fetch_array($query)){
    ...
    <td> &nbsp; <a href="updates.php?id=<?php echo $result['id'] ?>"> UPDATE <abbr title="UPDATE">  <i class="fa fa-wrench" aria-hidden="true"></i> </td></a> </abbr>
    <td> &nbsp; <a href="deletes.php?id=<?php echo $result['id'] ?>"> DELETE <abbr title="DELETE">  <i class="fa fa-trash" aria-hidden="true"></i> </td></a> </abbr> 
